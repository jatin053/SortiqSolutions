...
<main class="font-raleway">
    <div class="bg-[#f9fafb] min-h-screen font-sans">
      <div class="h-[180px] relative bg-cover bg-center" style="background-image:url('{{ asset('frontend-assets/media/pages/videos/videos-hero.webp') }}')">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          @forelse ($videos as $video)
            <div
              ...
              class="bg-white rounded-xl shadow-md overflow-hidden h-[230px] transition-transform hover:scale-[1.02] relative group cursor-pointer"
            >
